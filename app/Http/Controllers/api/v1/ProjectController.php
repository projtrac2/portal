...
class ProjectController extends Controller
{
    ...
    public function yearDistributionPost(Request $request)
    {
        $request->validate([
            'task_start_date' => 'required',
            'task_end_date' => 'required',
            'project_start_year' => 'required',
            'project_duration' => 'required'
        ]);

        return $this->yearDistribution(
            $request->task_start_date,
            $request->task_end_date,
            $request->project_start_year,
            $request->project_duration,
        );
    }


    public function yearDistribution(/*$taskStartDate, $taskEndDate, $startYear, $prjDuration*/)
    {
