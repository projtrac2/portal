                ...
                $.ajax({
                  ...
                  $('#numPreInvestment').text(response[0]);
                    ...
                    $('#numCompleted').text(response[3]);
                        ...
                        // for (let i = 0; i < response.projectDistributionPerSubCounty.length; i++) {
                        //     projDistributionName.push(response.projectDistributionPerSubCounty[i].state);
                        //     projDistributionData.push(response.projectDistributionPerSubCounty[i].num_of_projects);
                        // }
